...
redemption_history_table = Table(
    ...
    Column("card_number", String(100), nullable=False, comment="兑换卡卡号"),
    Column("amount", Numeric(10, 2), nullable=False, comment="兑换金额"),
    Column("status", TINYINT, nullable=False, comment="状态：1成功 2失败"),
    ...
    Column("updated_at", DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"), comment="更新时间"),
